...
What's Next:
  ...
  * Customize it by editing the implementation file: ``LandFill_Site_Selection.py``

  * Create your own custom icon, replacing the default icon.png

  * Modify your user interface by opening LandFill_Site_Selection_dialog_base.ui in Qt Designer
